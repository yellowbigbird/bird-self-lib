...
public:
	...
	void	SearchAllFiles();
	void	FindAllFile(const std::wstring& strPath, std::vector<CFileInfo>& vecFiles, CFileInfo& rootFile);
    ...
    void    GetRootFile(CFileInfo& fileInfo) const;
