    ...
    public class CodeOutlineCache
    {
        ...
        private void AdviseCodeModelEvents()
        {
            ...
            {    // Failed to get CodeModelEvents, this should not occur.
                SourceOutliner.DisplayMessage(Resources.ErrorPrefix, "Failed to get Code Model events.");
                throw;
            }
        }
        ...
        private void codeModelEvents_Added(CodeElement newElement)
        {
            ...
            {
                SourceOutliner.DisplayMessage(Resources.ErrorPrefix, "codeModelEvents_Added exception: " + ex.ToString());
            }
        }
        ...
        private void codeModelEvents_Deleted(object parent, CodeElement deletedElement)
        {
            ...
            {
                SourceOutliner.DisplayMessage(Resources.ErrorPrefix, "codeModelEvents_Deleted exception: " + ex.ToString());
            }
        }
        ...
        private void codeModelEvents_Changed(CodeElement modifiedElement, vsCMChangeKind iChangeType)
        {
            ...
            {
                SourceOutliner.DisplayMessage(Resources.ErrorPrefix, "codeModelEvents_Changed exception: " + ex.ToString());
            }
        }
    }
}
